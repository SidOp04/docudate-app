                    ...
                    children: [
                              ...
                              children:
                                ...
                                return ChoiceChip(
                                  ...
                                  selectedColor: const Color(
                                      0xff006AFA), // Background color when selected
                                  backgroundColor: const Color(
                                      0xffF0EFFF), // Background color when not selected
                                  labelStyle: GoogleFonts.poppins(
                                    color: isSelected
                                        ? Colors.white
                                        : const Color(0xff006AFA), // Text color
                                  ),
                                  shape: RoundedRectangleBorder(
                                    ...
                                    side: BorderSide(
                                      color: isSelected
                                          ...
                                          : const Color(0xff006AFA), // Border color
                          ...
                          decoration: InputDecoration(
                            ...
                            border: OutlineInputBorder(
                              ...
                              borderSide: const BorderSide(
                                color: Color(0xff006AFA), // Blue border color
                      ...
                      SizedBox(
                        ...
                        child: DropdownButtonFormField<String>(
                          value: city,
                          items: ['Cherthala', 'Ernakulam', 'Edapally', 'Aluva']
                              .map((String city) {
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
                                const Color(0xff006AFA), // Background color (blue)
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(
                                  10.0), // Rounded corners
                            ),
